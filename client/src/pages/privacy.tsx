      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <section className="mb-8">
            ...
            <p>
              At Legacy Capital Partners ("Legacy," "we," "us," or "our"), we value your privacy and are committed to 
              protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and 
              safeguard your information when you visit our website, use our services, or interact with us in any way.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              financial information, and other information necessary to provide our services.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Financial institutions and partners necessary to complete transactions</li>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              However, some parts of our website may not function properly if you disable cookies.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              updated "Last Updated" date and will be effective as soon as it is accessible. We encourage you 
              to review this Privacy Policy periodically to stay informed of how we are protecting your information.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              <strong>Email:</strong> contact@legacycapital.com<br />
              <strong>Phone:</strong> (555) 123-4567<br />
              <strong>Address:</strong> 123 Financial District, Suite 500, New York, NY 10001
            </p>
          </section>
        </motion.div>
      </div>
